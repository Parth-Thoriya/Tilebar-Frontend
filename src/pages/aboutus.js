...
function Aboutus() {
    return (<>
        ...
        <div className="m-5 p-5 shadow  rounded-pill  d-flex align-items-center">
            <div className='row'>
                <h1>OUR PROCESS</h1>
                <h3>
            ...
            <div id="third_cards">
                <div>
                    <h4>End to End Solutions and Services Guaranteed</h4>
                    <p>
                ...
                <div>
                    <h4>Ahead of The Curve We Future-proof Your IT</h4>
                    <p>
                        Fusce nec tellus sed augue semper porta. Mauris massa.
                ...
                <div>
                    <h4>Experience Certainty Every Project Executed Successful</h4>
                    <p>
                        Fusce nec tellus sed augue semper porta. Mauris massa.

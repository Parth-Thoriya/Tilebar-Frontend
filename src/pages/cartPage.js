        ...
        .then(resUser => {
          fetch(
            ...
            res => {
              ...
              // console.log("### cart get user##", user)
              // console.log("### cart get  ##", cart)
              // console.log("### cart get items##", cartItems)
...
const formateditems = cartItems.map((pt)=>{
  ...
  //   fetch("http://localhost:5454/api/payment/pay", {
  //     method: 'Post',
  //     headers: {
  //       'content-type': 'application/json',
  //       'authorization': getToken(),
  //     },
  //     body: JSON.stringify({ token: token, totalamount: Number.parseInt(price), products: cartItems.map((pt) => pt.product) })
  //   })
  //     .then(res => {
  ...
  //       //     localStorage.clear()
  //       // }
  //       console.log("### res raw token payment", res)

  //       return res.json()
  //     })
  //     .then(res => {
  //       console.log("### res token payment", res)
